...
function comboFunction(object) {
    ...
    if(selcetOption === "בית עסק לפי מיקום") {
        ...
        comboElement.innerHTML = '<form id="combo_box" action="/profile/futureSearch" method="get"><p>בחר עיר לבילוי עתידי: </p><select name="combo1" id="combo1"><option value="" selected disabled hidden>בחר עיר:</option><option value="באר שבע"> באר שבע</option></select><br><p>בחר שעה רצויה: </p><select name="combo2" id="combo2"><option value="" selected disabled hidden>בחר שעה:</option><option value="17:00-18:00"> 17:00-18:00</option><option value="18:00-19:00"> 18:00-19:00</option><option value="19:00-20:00"> 19:00-20:00</option><option value="20:00-21:00"> 20:00-21:00</option><option value="21:00-22:00"> 21:00-22:00</option></select><br><br><button id="submit2" type="submit2">יאללה תמצאו לי</button></p></form>'
    }
    else {
